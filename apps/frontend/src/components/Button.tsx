...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={clsx(
        `text-hitam flex items-center justify-center px-3 transition-all duration-300 active:scale-95 disabled:hover:bg-none disabled:active:scale-100 md:px-6 py-3`,
        fullWidth && 'w-full',
